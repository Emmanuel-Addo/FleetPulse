const Testimonails = () => {
  const testimonials = [
    {
      text: "FleetPulse has completely transformed how we manage our delivery trucks. The real-time telemetry is incredibly accurate and reliable.",
      name: "Kwame Mensah",
    ...
    {
      text: "Being able to see our entire fleet on a single map, complete with battery health and speed alerts, saves us hours every day.",
      name: "Sarah Jenkins",
      role: "Fleet Manager",
      image:
    ...
    {
      text: "The actionable insights and automated maintenance reminders have reduced our vehicle downtime by 30% this quarter.",
      name: "David Osei",
    ...
    {
      text: "I love how easy it is to dispatch maintenance issues directly from the dashboard. The UI is clean, intuitive, and fast.",
    ...
    {
      text: "FleetPulse's routing and live tracking features ensure our drivers stay on course, dramatically improving our delivery times.",
      name: "Mark Thompson",
    ...
    {
      text: "Finally, a telemetry dashboard that doesn't feel cluttered. It gives us exactly the metrics we need without the noise.",
      name: "Amma Frimpong",
      role: "Fleet Analyst",
      image:
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-neutral-600 text-sm max-w-96 mx-auto">
              Real feedback from logistics directors, dispatchers, and
              operations teams managing real fleets.
            </p>
          </div>
