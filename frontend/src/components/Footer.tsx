        ...
        <footer className='flex flex-col justify-end bg-black pt-20 px-4 sm:px-6 lg:px-8 overflow-hidden w-full'>
            <div className='w-full max-w-7xl mx-auto'>
                <div className="flex flex-wrap justify-between gap-y-12 lg:gap-x-8">
                    ...
                    <div className="w-full md:w-[45%] lg:w-[35%] flex flex-col items-start text-left">
                        <Link to="/" className="flex items-center gap-2">
                            ...
                            <span className="text-white text-2xl font-bold tracking-tight">FleetPulse</span>
                        </Link>
                        ...
                        <p className='text-sm text-white/60 mt-6 max-w-[350px] leading-relaxed'>
                            FleetPulse is a next-generation fleet management telemetry console built for real-time monitoring, logistics efficiency, and seamless asset tracking.
                        </p>
                    </div>
                    ...
                    <div className="w-[45%] md:w-[45%] lg:w-[15%] flex flex-col items-start text-left">
                        ...
                        <div className="flex flex-col gap-2 mt-6">
                            ...
                            <Link to="/tracking" className='text-sm text-white/60 hover:text-white transition-colors'>Live Tracking</Link>
                            <Link to="/vehicles" className='text-sm text-white/60 hover:text-white transition-colors'>Vehicles</Link>
                            <Link to="/drivers" className='text-sm text-white/60 hover:text-white transition-colors'>Drivers</Link>
                            <Link to="/issues" className='text-sm text-white/60 hover:text-white transition-colors'>Issues</Link>
                        </div>
                    </div>
                    ...
                    <div className="w-full md:w-[45%] lg:w-[25%] flex flex-col items-start text-left mt-4 md:mt-0">
                        ...
                        <div className="flex items-center border gap-2 border-white/20 h-12 max-w-80 w-full rounded-full overflow-hidden mt-4 bg-white/5">
                            <input type="email" placeholder="Enter your email.." className="w-full h-full pl-6 outline-none text-sm bg-transparent text-white placeholder-white/60" required />
                            <button type="submit" className="bg-white hover:bg-gray-200 text-black font-semibold transition w-32 h-10 rounded-full text-sm cursor-pointer mr-1 focus:outline-none">Subscribe</button>
                        </div>
                    </div>
                ...
                <div className="flex flex-wrap sm:flex-row items-center justify-between gap-y-4 gap-x-2 relative z-10">
                    <p className='text-xs text-white/60'>© {new Date().getFullYear()} FleetPulse by Emmanuel Addo</p>
